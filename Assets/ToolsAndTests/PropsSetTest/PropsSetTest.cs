...
public class PropsSetTest : MonoBehaviourPunCallbacks
{
    ...
    {
        Debug.Log("OnConnectedToMaster() was called by PUN. Calling: PhotonNetwork.JoinRandomRoom();");
    ...
    public override void OnJoinRandomFailed(short returnCode, string message)
    {
        ...
        roomOptions.CustomRoomProperties = new Hashtable() {{"C", (int)0}};
        roomOptions.CustomRoomProperties.Add("L", "someLanguage");
    ...
    public override void OnJoinedRoom()
    {
        ...
        Debug.LogWarning("Custom Room Properties: " + PhotonNetwork.CurrentRoom.CustomProperties.ToStringFull());

        Hashtable propUpdate = new Hashtable();
        propUpdate.Add("C", true);
        PhotonNetwork.CurrentRoom.SetCustomProperties(propUpdate);

        Debug.LogWarning("Custom Room Properties Contains \"C\": " + PhotonNetwork.CurrentRoom.CustomProperties.ContainsKey("C"));
    }

    public override void OnRoomPropertiesUpdate(Hashtable propertiesThatChanged)
    {
        Debug.LogWarning("OnRoomPropertiesUpdate: " + PhotonNetwork.CurrentRoom.CustomProperties.ToStringFull());
    }
}
